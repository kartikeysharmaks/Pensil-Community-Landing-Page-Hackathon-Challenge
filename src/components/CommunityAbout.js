...
const CommunityAbout = () => {
  return (
    <div className="sm:pt-10 pb-10 bg-gray-100">
      <div className="w-[95% ] mx-auto sm:my-4 my-1 pt-4 lg:text-8xl sm:text-5xl text-3xl text-pink-400 font-bold text-center">
      ...
      <div className="flex flex-row items-center justify-center sm:pt-6 pt-2 sm:pb-7 pb-8">
        <button
          type="button"
          className="sm:py-4 py-2 sm:px-6 px-3 bg-gray-500 text-white font-semibold sm:text-2xl text-xl rounded-xl hover:bg-gradient-to-r from-blue-900 to to-pink-500"
        >
